...
Sacred governance is like [sacred cows](https://en.wikipedia.org/wiki/Sacred_cow_(idiom)). Cool in theory. Less cool IRL.
...
Many arguments are [formally valid, but informally fallacious](https://en.wikipedia.org/wiki/Fallacy). This is hard to detect, but incredibly important. Critical thinking can help identify formal fallacies, and questioning the assumptions that a proposal is dependent on can help identify informal fallacies.
...
[This list](https://medium.com/@Vlad_Zamfir/how-to-participate-in-blockchain-governance-in-good-faith-and-with-good-manners-bd4e16846434) is a good start to think about how to engage in good faith.
